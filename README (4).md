...
A console-based user registration and login system built in C++ using OOP and file handling.
...
```
g++ RegistrationForm.cpp -o RegistrationForm.exe
.\RegistrationForm.exe
```
